...
export class SubContractorController extends BaseController<SubContractorDTO, SubContractorRepository> {
    ...
    async contactPersons(req: Request, res: Response) {
        ...
        let records = await repository.getAllContactPersons(parseInt(organizationId));
